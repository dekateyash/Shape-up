...
// const USER_STATUS_URL = "http://localhost:9000/api/user/status";
// const USER_MEAL_PLAN_URL = "http://localhost:9000/api/user/meal-plan";
// const USER_WATER_INTAKE_URL = "http://localhost:9000/api/users/water-intake";
